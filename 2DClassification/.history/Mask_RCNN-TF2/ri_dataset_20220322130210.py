...
def change_xml_files():
    ...
    path = '../range_images_anot/car_0027_flat_25_-0.xml'
    mytree = ElementTree.parse(path)
    myroot = mytree.getroot()[0]
    myroot.folder.text = "range_images"
    myroot.path.text = "/Users/vasilieiosvamvakas/Documents/Project/2DClassification/range_images/cylinder_flat_25_-1_726.png"
