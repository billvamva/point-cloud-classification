...
class background_subtractor():
    ...
    def ml_background_subtraction(self, image):
        ...
        model_path = './Mask_RCNN/mask_rcnn_ri_cfg_0015.h5'

        boxes = find_mask(image, model_path)
        y1, x1, y2, x2 = boxes[0]
        ...
        output_image = cv2.bitwise_and(image, image, mask)

        cv2.imwrite("./b_range_images/test_rm.png", output_image)
...
if __name__ == "__main__":
    ...
    bg_sub = background_subtractor(cv2.imread("range_images/car_0027_flat_25_-1_838.png"))

    print(bg_sub.mask_coords)