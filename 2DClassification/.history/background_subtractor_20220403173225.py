...
class background_subtractor():
    ...
    def ml_background_subtraction(self, image):
        ...
        cv2.rectangle(mask, (x1, x2 + 1), (y1, y2 + 1), 255, -1)

        output = cv2.bitwise_and(image, image, mask = mask)

        cv2.imwrite("./b_range_images/test_rm.png", image)
...
if __name__ == "__main__":
    ...
    bg_sub = background_subtractor("range_images/car_0027_flat_25_1_187.png")
