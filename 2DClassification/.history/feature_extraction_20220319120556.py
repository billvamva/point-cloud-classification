...
class Feature_Extractor():
    ...
    def __init__(self, path = "", data_path = "./range_images/", filename = "", hog_glcm = True, glcm_window_size = 7, glcm_step_size = 500, orb = False):
    ...
    def combine_features(self, data_path):
        ...
        init_file = "car_0027_flat_25_-0.png"

        feature_size = self.get_features(path + init_file)
