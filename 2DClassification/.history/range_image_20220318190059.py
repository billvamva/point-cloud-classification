...
class range_image():
    ...
    def __init__(self, filename, obj_class, dst_path = "./range_images/", bg_rm = False, vox = 0.01, path = ""):
        """
    ...
    def save_image(self, dst_path):
        ...
        fig.savefig(f"{dst_path}{self.obj_class}_{self.filename.split('.')[0]}.png")
        plt.close(fig)
