...
class Feature_Extractor():
    ...
    def __init__(self, path, filename = "", hog_glcm = True, glcm_window_size = 7, glcm_step_size = 500, orb = True):
        ...
        if hog_glcm:
            self.features, self.labels = self.combine_features()
    ...
    def get_hog_features(self, img):
        ...
        hog_features = hog(img, block_norm='L2-Hys', pixels_per_cell=(64, 64))
    ...
    def combine_features(self):
        ...
        for file in os.listdir(path):
            ...
            if filename != ".DS_Store":
                ...
                features = np.vstack([features, np.hstack((hog_features, glcm_features))])
