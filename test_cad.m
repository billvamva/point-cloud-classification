% model = createpde(3);
% importGeometry(model,'watertight_blocc_1.stl');
% pdegplot(model,'FaceLabels','on');
% model = offLoader('Princeton/ModelNet10/bed/test/bed_0516.off')
%% --------------------------------------------------------------- preamble
clc; clear; clf; close all; format compact;
%% --------------------------------------------------------------- settings
fileID = fopen('Princeton/ModelNet10/bed/test/bed_0516.off');
